...
export function createTelemetryPlugin(metrics: import('@confused-ai/contracts').MetricsCollector): Plugin {
    return {
...
export type { Plugin, PluginContext } from '@confused-ai/contracts';
