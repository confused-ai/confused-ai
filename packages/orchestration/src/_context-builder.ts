...
export class AgentContextBuilder {
    ...
    static fromContext(context: AgentContext): AgentContextBuilder {
        ...
        builder.memory = context.memory as MemoryStore | undefined;
        builder.tools = context.tools as ToolRegistry | undefined;
        builder.planner = context.planner as Planner | undefined;
