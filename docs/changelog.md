---
title: Changelog
description: All notable changes to Fluxion
---
...
#### Adapter System (`fluxion/adapters`)
...
- Plugin system — `fluxion/plugins` with built-in logging, rate-limit, telemetry plugins
- Contracts layer — `fluxion/contracts` for shared interfaces without runtime code
