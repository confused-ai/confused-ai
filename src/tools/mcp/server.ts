 ...
 * @example
 * ```ts
 * import { createMcpServer } from 'fluxion/tools';
 * import { toToolRegistry, calculatorTool } from 'fluxion/tools';
 *
...
import type { MCPServerAdapter, MCPToolDescriptor } from '../../orchestration/core/mcp-types.js';
