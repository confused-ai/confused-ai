 ...
 * Web search toolkit
 */
export const WebSearchToolkit = {
    createDuckDuckGo(options?: { modifier?: string; enableNews?: boolean }): Array<DuckDuckGoSearchTool | DuckDuckGoNewsTool> {
    ...
    createGeneric(options?: { modifier?: string }): Array<WebSearchTool> {
