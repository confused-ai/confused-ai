...
export type { EntityId, AgentInput, AgentOutput, AgentContext } from '../../core/index.js';
export { AgentState } from '../../core/index.js';
// Also export the public Agent interface (has .id, .name, .run(prompt))
export type { Agent } from '../../core/index.js';

// Local imports for use within this file
import type { EntityId, AgentInput, AgentOutput } from '../../core/index.js';
...
export interface OrchestrableAgent {
    ...
    run(input: AgentInput, ctx: import('../../core/index.js').AgentContext): Promise<AgentOutput>;
}
